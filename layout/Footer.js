          ...
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              <ul className="footer-bottom-nav">
                <li>
                  <a href="https://www.linkedin.com/in/chinzoo/">LinkedIn</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/ch.zorigg/">Instagram</a>
                </li>

                <li>
                  <a href="https://gitlab.com/chinzoo-Everest">GitLab</a>
                </li>
                <li>
                  <a href="https://github.com/chinzoo0715">GitHub</a>
                </li>
              </ul>
            </div>
          </div>
