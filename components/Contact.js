          ...
          <div className="col-lg-4">
            <div className="contact-content-part pt-5 rpt-0 rmb-55 wow fadeInUp delay-0-2s">
              <div className="section-title mb-40">
                ...
                <p>
                  Got a project in mind? I'm ready to help bring your vision to
                  life. With a knack for innovation and a commitment to quality,
                  I'm your go-to for turning ideas into reality. Let's create
                  something outstanding together. Reach out and let’s get
                  started.
                </p>
              </div>
            </div>
          ...
          <div className="col-lg-8">
            <div className="contact-form contact-form-wrap form-style-one wow fadeInUp delay-0-4s">
              <form
                ...
                name="contactForm"
                action="https://formsubmit.co/01d3b061e7836ca3d098760e25320a19"
                method="post"
              >
                <div className="row">
