...
const counterData = [
  { id: 1, text: "Years Of Experience", value: "4" },
...
const Hero = () => {
  return (
    <section id="home" className="main-hero-area pt-80 pb-80 rel z-1">
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h1>
                <b>Chinzo</b> software developer
              </h1>
              <p>"In code, creativity meets diligence, crafting the future."</p>
              <div className="hero-btns">
                <Link
                  className="theme-btn"
                  target="_blank"
                  href="https://firebasestorage.googleapis.com/v0/b/my-portfolio-6f11f.appspot.com/o/chinzorig.p.pdf?alt=media&token=7603792d-fca3-4874-9909-dd024babd9af"
                >
