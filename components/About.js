            ...
            <div className="col-lg-7">
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <h2>
                    Crafting the Future with <span>Code</span>
                  </h2>
                  <p>
                    Hello! I'm a passionate software developer deeply immersed
                    in the art of exploring new technologies and advancing the
                    frontier of innovation. My journey is marked by a relentless
                    pursuit of knowledge, the construction of scalable
                    applications, and the design of immersive user experiences.
                    Excelling in both teamwork and communication, I strive to
                    bring meaningful contributions to projects that resonate
                    with significance. Beyond the realm of coding, I find
                    balance and inspiration in the great outdoors, where skiing,
                    swimming, and cycling invigorate my creativity and enrich my
                    personal life. This fusion of technical acumen and personal
                    passions culminates in software that not only stands out but
                    truly makes an impact. I invite you to explore my portfolio
                    and see the synthesis of creativity and skill in action.
                    Together, let's explore the possibilities and build the
                    future.
                  </p>
                </div>
                ...
                <div className="about-info-box mt-25 wow fadeInUp delay-0-2s">
                  <div className="info-box-item">
                    ...
                    <div className="content">
                      <span>Email Me</span>
                      <br />
                      <a href="mailto:cpurevjamts@gmail.com">
                        cpurevjamts@gmail.com
                      </a>
                    </div>
                  </div>
                  <div className="info-box-item">
                    ...
                    <div className="content">
                      ...
                      <br />
                      <a href="callto:+97686899766">+976 86899766</a>
                    </div>
                  </div>
                </div>
              </div>
